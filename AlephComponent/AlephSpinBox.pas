...
type
  TAlephSpinBox = class( TSpinBox, IRemFontSize, IGlobalFontSizeAware,
...
procedure TAlephSpinBox.DoFormResize( Sender : TObject );
  begin
...
procedure TAlephSpinBox.SetGlobalFontSizeManager( const Value
  : TGlobalFontSizeManager );
  begin
...
procedure TAlephSpinBox.Notification(
  AComponent : TComponent;
