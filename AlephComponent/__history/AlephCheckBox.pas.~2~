...
type
  TAlephCheckBox = class(TCheckBox, IRemFontSize, IGlobalFontSizeAware, IFontSizeAdjustable, IResizable, ITextSettings)
  private
...
procedure TAlephCheckBox.SetGlobalFontSizeManager(const Value: TGlobalFontSizeManager);
begin
...
procedure TAlephCheckBox.Notification(AComponent: TComponent; Operation: TOperation);
begin
  inherited;
