...
type
  TAlephButton = class(TButton, IRemFontSize, IGlobalFontSizeAware, IFontSizeAdjustable, IResizable)
  private
...
procedure TAlephButton.SetGlobalFontSizeManager(const Value: TGlobalFontSizeManager);
begin
...
procedure TAlephButton.Notification(AComponent: TComponent; Operation: TOperation);
begin
  inherited;
