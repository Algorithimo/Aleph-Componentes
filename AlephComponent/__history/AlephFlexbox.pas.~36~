...
procedure TFlexContainer.ClearItems;
begin
  FItems.Clear;
  // Se você quiser desalocar ou liberar os controles, pode fazer isso aqui.
  for var Control in FItems do
  Control.Free; // Liberando os controles, se necessário.
end;
