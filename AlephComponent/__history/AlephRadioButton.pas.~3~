...
uses
  ...
  FMX.StdCtrls, FMX.Objects, FMX.Graphics, FMX.TextLayout, AlephRem, AlephTipos, AlephREmFont, GlobalFontSizeManager, ResizeManager;

type
  TAlephRadioButton = class(TRadioButton, IRemFontSize, IGlobalFontSizeAware, IFontSizeAdjustable, IResizable, ITextSettings)
  private
...
procedure TAlephRadioButton.SetGlobalFontSizeManager(const Value: TGlobalFontSizeManager);
begin
...
procedure TAlephRadioButton.Notification(AComponent: TComponent; Operation: TOperation);
begin
  inherited;
